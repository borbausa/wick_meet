# Wick Meet Privacy Policy

*Last updated: [Current Date]*

## Our Privacy-First Commitment

Wick Meet is built on the principle that your meeting data should remain private and under your control. This privacy policy explains how we handle data in our open-source meeting assistant.
...
### What We Collect
To improve Wick Meet and ensure optimal performance, we collect minimal, anonymized usage data:
...
*This privacy policy applies to Wick Meet v0.0.5 and later versions. For enterprise deployments, additional privacy controls may be available.*